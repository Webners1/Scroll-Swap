      ...
      <>
        <Box>
          <Text display="inline" color="currentColor">
            ...
            <p>
              {t(
                "To earn Merkl rewards, continue seeding liquidity on LolPadSwap but DO NOT stake your LP token in the Farm. Claim your rewards directly on "
              )}
            ...
            <br />
            {t("To earn Farm rewards, continue seeding liquidity on LolPadSwap and stake your LP token in the Farm.")}
          </Text>
        </Box>
      </>
    );
    ...
    <>
      <Box>
        <Text display="inline" color="currentColor">
          ...
          <br />
          {t(
            "To earn Merkl rewards, continue seeding liquidity on LolPadSwap, but DO NOT stake your LP token in the Farm. Otherwise, you will not accrue rewards."
          )}
        </Text>
      </Box>
    </>
