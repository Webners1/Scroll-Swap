...
export const pancakeProtectors: GameType = {
  ...
  description:
    'LolPadSwap and Mobox joined forces to launch a tower-defense and PvP game tailored for GameFi players, as well as CAKE, Pancake Squad, and Bunnies holders.',
  ...
  playlist: [
    {
      videoId: '80j7QpNqKcI',
      title: 'Unleashing the Power of Pancake Protectors: A Web3 Gaming Adventure on LolPadSwap',
    },
    {
      videoId: '--UcFQ64sjY',
