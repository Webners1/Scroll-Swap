...
export const ifos: BaseIfoConfig[] = [
  {
    ...
    description:
      'Cakepie is a veCAKE Manager that boosts rewards for CAKE stakers and LolPadSwap’s liquidity providers, as part of the wider [veCAKE Ecosystem](https://docs.pancakeswap.finance/products/vecake/vecake-managers)',
    vestingTitle:
