...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.SCROLL_SEPOLIA]: '0x4396c4a9637c9D230c9990EDaB794064aD5511c8',
  [ChainId.SCROLL]: '0x9d4277f1D41CCB30C0e91f7d1bBA2A739E19032C',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.SCROLL_SEPOLIA]: '0x5283635E18E6B4f30554c1Bee1c151B446118008',
  [ChainId.SCROLL]: '0x6cc56b20bf8C4FfD58050D15AbA2978A745CC691',
} as const satisfies Record<ChainId, Address>
