...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.SCROLL_SEPOLIA]: '0x610Ad043e0FC47E5F1fefA16F041CC2A0Ff3A06C',
  [ChainId.SCROLL]: '0xa234143d985310E7BE408AC9ADc11216c8abB62B',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.SCROLL_SEPOLIA]: '0x87E780223d9e8157fd97b44052AcBC6b3125756f',
  [ChainId.SCROLL]: '0xAaba283723B67503FB8367aDED56Ebecf7b91e34',
} as const satisfies Record<ChainId, Address>
