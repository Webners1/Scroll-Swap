...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">LolPadSwap Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: Sep 1, 2023</Text>
        <Text as="p">
          This LolPadSwap Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and LolPadSwap that applies to your participation in the LolPadSwap Affiliate
          Program (“Program”). In this Agreement, “<strong>LolPadSwap</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means LolPadSwap. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by LolPadSwap.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on LolPadSwap, in accordance with the terms of this
          Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the LolPadSwap platform or used
          any of LolPadSwap’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“LolPadSwap
          Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on LolPadSwap V2 and LolPadSwap V3, limited to
          swap trades on the BNB Smart Chain, Ethereum chain, Polygon zkEVM, zkSync Era, Arbitrum One, Linea, and Base
          chain only; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          7.3 Any statements you make about LolPadSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to LolPadSwap that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of LolPadSwap for any purpose.
          ...
          offers or representations on behalf of LolPadSwap. You shall have no authority to bind LolPadSwap, and
          undertake not to hold yourself out as an employee, agent or authorised representative of LolPadSwap.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and LolPadSwap, or attribute any
          materials created or issued by you (including press releases) to LolPadSwap.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 LolPadSwap reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the LolPadSwap website and
          all images of LolPadSwap and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 LolPadSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other LolPadSwap service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 LolPadSwap reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify LolPadSwap from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          LolPadSwap and any of LolPadSwap&apos;s officers, directors, employees, shareholders or agents of any of them,
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of LolPadSwap Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any LolPadSwap products and services to users in the
        ...
        <Text as="p">
          LolPadSwap may provide you with trademarks and/or graphical images that can be used to promote LolPadSwap. You
          may not modify these trademarks and/or images in any way. LolPadSwap reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting LolPadSwap. For example:
        </Text>
        <Text as="p">
          (a) If you promote LolPadSwap through a web page, podcast, blog post, or social media post as an endorsement
          or review of LolPadSwap or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by LolPadSwap; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by LolPadSwap from time to
