  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about LolPadSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 LolPadSwap reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 LolPadSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 LolPadSwap reserves the right to refuse service to anyone for any reason at any time.</Text>
