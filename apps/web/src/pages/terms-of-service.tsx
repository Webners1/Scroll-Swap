...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">LolPadSwap Terms of Service</Text>
      ...
      <Text as="p" fontWeight="600" color="white">
      ...
      <Text as="p" color="white">
        ...
        LolPadSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p" color="white">
        ...
        Chain, Aptos and Ethereum. LolPadSwap does not control or operate any version of the Protocol on any blockchain
        ...
        LolPadSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p" color="white">
        LolPadSwap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p" color="white">
        ...
        such as rarity scores, token explorer or token lists (which includes the LolPadSwap default token list and
        LolPadSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p" color="white">
        ...
        of any other digital tokens which are transacted on LolPadSwap.
      </Text>
      <Text as="p" color="white">
      ...
      <Text as="p" color="white">
        ...
        as otherwise expressly set forth in the terms of another offer by LolPadSwap, you will be solely responsible to
