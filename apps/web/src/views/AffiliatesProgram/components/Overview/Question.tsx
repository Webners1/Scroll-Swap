    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a LolPadSwap affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t('Strong understanding of LolPadSwap and our ecosystem')}
              </StyledListText>
            </FoldableText>
            <FoldableText title={t('How do I earn commissions as an affiliate?')} mt="24px">
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t('Pairs must be in the LolPadSwap Token list for the following chains (')}
                <Link
                  external
