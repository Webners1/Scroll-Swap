        ...
        <Flex width={['100%', '100%', '447px']} alignSelf={['center']} flexDirection="column" alignItems="center">
          <Box m={['32px 0']}>
            <Text
              ...
              bold
            >
              {t("Join LolPadSwap's Community and Make a Difference")}
            </Text>
          </Box>
          <Text textAlign={['left', 'left', 'left', 'center']} color="textSubtle" mb="32px">
            {t(
              "As an affiliate, you'll be part of a network of like-minded individuals who are committed to build a stronger DeFi community. Be part of something bigger with LolPadSwap's Affiliate program",
            )}
          </Text>
          <Link
            external
