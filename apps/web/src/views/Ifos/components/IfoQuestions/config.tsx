...
const config = [
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          In the Public Sale, everyone with an active LolPadSwap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active LolPadSwap Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
