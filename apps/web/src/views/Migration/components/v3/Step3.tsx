  ...
  return (
    <AtomBox textAlign="center">
      <Heading scale="lg" pb="16px">
        {t('Quick Start')} - {t('LolPadSwap V3')}
      </Heading>
      <Text pb="48px">
        {t(
          'In LolPadSwap Exchange V3, liquidity providers are able to customize the trading fee tier and concentrate their liquidity to a specific price range to maximize their capital efficiency.',
        )}
      </Text>
